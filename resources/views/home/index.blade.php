                ...
                <div id="content-section" class="bg-white rounded-lg shadow p-4 md:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="border border-gray-200 rounded-lg p-5">
                            ...
                            <ul class="space-y-2">
                                <li><a href="#" class="text-indigo-600 hover:text-indigo-800 flex items-center" data-section="libros"><i class="fas fa-plus-circle text-sm mr-2"></i> Agregar nuevo libro</a></li>
                                <li><a href="#" class="text-indigo-600 hover:text-indigo-800 flex items-center" data-section="usuarios"><i class="fas fa-user-plus text-sm mr-2"></i> Registrar nuevo usuario</a></li>
                                <li><a href="#" class="text-indigo-600 hover:text-indigo-800 flex items-center" data-section="prestamos"><i class="fas fa-handshake text-sm mr-2"></i> Registrar préstamo</a></li>
                                <li><a href="#" class="text-indigo-600 hover:text-indigo-800 flex items-center" data-section="prestamos"><i class="fas fa-undo-alt text-sm mr-2"></i> Registrar devolución</a></li>
                            </ul>
                        </div>
                    ...
                    <!-- Préstamos recientes -->
                    <div class="mt-8">
                        <h4 class="font-bold text-gray-800 mb-4">Préstamos Recientes</h4>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        <td class="px-4 py-3 whitespace-nowrap">María González</td>
                                        <td class="px-4 py-3">Cien años de soledad</td>
                                        <td class="px-4 py-3">15/05/2023</td>
                                        <td class="px-4 py-3">30/05/2023</td>
                                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">Activo</span></td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 whitespace-nowrap">Carlos Ruiz</td>
                                        <td class="px-4 py-3">El principito</td>
                                        <td class="px-4 py-3">10/05/2023</td>
                                        <td class="px-4 py-3">25/05/2023</td>
                                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800">Por vencer</span></td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 whitespace-nowrap">Ana Martínez</td>
                                        <td class="px-4 py-3">Don Quijote de la Mancha</td>
                                        <td class="px-4 py-3">01/05/2023</td>
                                        <td class="px-4 py-3">16/05/2023</td>
                                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs rounded-full bg-red-100 text-red-800">Vencido</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
