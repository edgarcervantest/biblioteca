...
#agrupa rutas con Auth, un middleware por defecto de Laravel que verifica si el usuario esta autenticado
...
#agrupa rutas con Auth que verifica si el usuario esta autenticado y con user_type para otorgar acceso solo a admins
