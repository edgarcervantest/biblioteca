...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <a href="{{ route('categorias.create') }}" class="purple_button">Agregar categoría</a><br>
        <br><br>
            ...
            <tbody>
                @foreach ($categorias as $categoria)
                    <tr class="border-b transition-colors">
                        <td class="content_text px-3 sm:px-4 py-2 sm:py-3 whitespace-nowrap">{{ $categoria->id }}</td>
                        <td class="content_text px-3 sm:px-4 py-2 sm:py-3 wrap-break-word min-w-30">{{ $categoria->nombre }}</td>
                        <td class="content_text px-3 sm:px-4 py-2 sm:py-3 whitespace-nowrap">
                            <a href="{{ route('categorias.edit', $categoria->id) }}" class="purple_button inline-block text-sm">Editar</a>
